  ...
  return courseData ? (
    ...
    <div className='flex md:flex-row flex-col-reverse gap-10 relative items-start justify-between md:px-36 px-8 md:pt-30 pt-20 text-left'>
      ...
      <div className='max-w-xl z-10 text-gray-500'>
        <h1 className='text-[26px] md:text-[36px] lg:text-[44px] font-semibold text-gray-800'>{courseData.courseTitle}</h1>
      ...
      {/* right column */}
      <div className='max-w-[424px] z-10 shadow-lg rounded-t md:rounded-none overflow-hidden bg-white min-w-[300px] sm:min-w-[428px]'>
        ...
        <div className='p-5'>
            ...
            <div className='pt-6'>
              ...
              <ul className='ml-4 pt-2 text-sm md:text-default list-disc text-gray-500'>
                ...
                <li>Downloadable resources and souce code.</li>
                <li>Quizzes to test your khowledge.</li>

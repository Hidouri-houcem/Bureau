...
const Player = () => {
  ...
  const [initialRating,setInialRating] = useState(0)
  ...
  return courseData ?  (
    <>
    <div className='p-4 sm:p-10 flex flex-col-reverse md:grid md:grid-cols-2 gap-10 md:scroll-px-36'>
      {/* left column */}
